...
console.log(color(
`〔 - _ R2D2 _ - Por Ordem do meu Dono irei reiniciar..... 〕`))
setTimeout(() => {
startAle()
}, 500)
setTimeout(() => {
...
`Olá seja muito bem vindo sou R2D2 e vou atender você agora. Leia os termos nos links abaixo antes de comprar e esteja ciente dos mesmo\n
...
[{index: 1, quickReplyButton: {displayText: 'MENU PRINCIPAL', id: `${prefix}menu2`}}], selo)
}
...
sendBimgT(from, `${logo}`, `Olá seja muito bem vindo sou R2D2 e vou atender você agora. Leia os termos nos links abaixo antes de comprar e esteja ciente dos mesmo\n
Termo de compra* - https://paste.anasor.com/paste.php?raw&id=18756\n*termo de uso* - https://paste.anasor.com/paste.php?raw&id=18755\nAgora click no botão desejado.\n\n*NÃO MANDE ÁUDIO, DIGITE OK*?`, "",
[{index: 1,quickReplyButton: {displayText: 'MENU PRINCIPAL', id: `${prefix}menu2`}}], selo)
...
{title: "AUDIO SOBRE O DONO", rowId: `${prefix}infobot`, description: "R2D2"}]
}]
...
[{index: 1, urlButton: {displayText: 'MEU PV TELEGRAM', url: 'https://t.me/internetilimitada4587'}},
{index: 2, quickReplyButton: {displayText: 'MENU PARA MEMBROS', id: `${prefix}efeitos`}},
{index: 2, quickReplyButton: {displayText: 'MENU ADMNISTRADORES', id: `${prefix}adms`}}], selo)
break
...
case 'help':
case 'comandos':
sendBimg(from, `${logo}`, menu(prefix, NomeDoBot), "GUIA DE COMANDOS", [{buttonId: `${prefix}dono`, buttonText: {displayText: `🔸 COMANDOS DO DONO 🔸`}, type: 1}], selo) 
break
...
{buttonId: `${prefix}menu2`, buttonText: {displayText: `🔸 MENU 🔸`}, type: 1}], selo)
break 
...
┃
┣• ${!isGroup ? `𝑈𝑠??𝑎𝑟𝑖𝑜: ${pushname}` :  `𝐺𝑟𝑢𝑝𝑜: ${groupName}`}
┃
┣• 𝐷𝑎𝑡𝑎: ${date} 
┃
┣• 𝐻𝑜𝑟𝑎: ${hora1} 
